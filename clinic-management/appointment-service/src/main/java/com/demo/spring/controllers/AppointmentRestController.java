...
public class AppointmentRestController {
	...
	public ResponseEntity<Message> addAppointment(@RequestBody AppointmentDTO appointmentDTO)
		...
		if (patientDTO.getPatientId() != null && patientDTO.getPatientId().intValue()==(appointmentDTO.getPatientID().intValue())) {
			...
			if (doctorDTO.getDoctorID() != null && (doctorDTO.getDoctorID().equals(appointmentDTO.getDoctorID()))) {
